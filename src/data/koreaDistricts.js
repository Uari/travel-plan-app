// 여행 완료 기록용 대한민국 전국 행정구역(시/군/구) 데이터.
// 다트 게임용 관광지 리스트(KOREA_REGIONS)와 달리, 여기에는 어떤 국내 여행이든
// 세부 지역까지 기록할 수 있도록 모든 시/군/구를 도(道)별로 담는다.
// province 키는 countries.js의 KOREA_PROVINCES 값과 정확히 일치해야 한다.
// 아이콘(이모지)은 사용하지 않는다.
